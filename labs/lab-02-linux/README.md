...
![01b-systeme.png — Distribution Ubuntu 24.04 LTS + noyau Linux](f66d6d84-202b-44ce-9721-fa89654d6ae4.png)
...
![01c-ressources.png — Mémoire, disque et CPU disponibles](3a1b8583-e03b-4d4b-9dcf-5af892d30779.png)
...
![02a-creation-fichiers.png — mkdir, touch, echo, cp, mv en action](62b3d7e2-a391-4bf2-b667-682bab43ce36.png)
...
![02b-arborescence.png — Sortie de ls -la et tree du dossier lab](c9c47801-0bed-4aa3-8493-68277dc01b53.png)
...
![03-permissions-execution.png — chmod +x transforme rw-rw-r-- en rwxrwxr-x et lance hello.sh](f7b25428-62e8-4079-b164-48f187eb116d.png)
...
![04a-log-genere.png — Log applicatif complet avec INFO/DEBUG/WARN/ERROR/FATAL](2a706f41-7e8b-4eb9-9d2f-ae6d3522bae5.png)
...
![04b-analyse-log.png — grep, tail, awk pour extraire les erreurs](9f131255-c1ed-408c-a101-9de3b5a99ef2.png)
...
![05a-interfaces-ping.png — ip a affiche lo/eth0/docker0 puis ping vers 8.8.8.8](d2b79bde-3005-4086-b04c-237afe0e95b2.png)
...
![05b-curl-http.png — curl -I retourne HTTP/2 200 depuis google.com](e22a8562-4202-450c-98a1-3ce4537f8745.png)
...
![05c-dig-dns.png — dig google.com : ANSWER SECTION, Query time, SERVER](ecea3773-a350-448c-a9dd-9538b4adc251.png)
